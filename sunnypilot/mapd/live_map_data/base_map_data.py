...
class BaseMapData(ABC):
  # FusionPilot: extra_services so a subclass can add its own source without rebuilding the
  # SubMaster or duplicating the tick/publish loop. MapdV2MapData needs 'mapdOut'.
