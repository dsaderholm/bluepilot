...
DEFAULT_TARGETS = [
  ...
  "selfdrive/ui/tests/test_press_routing_reads_the_aim.py",
  "selfdrive/ui/tests/test_stepper_moves_once_per_tap.py",
  ...
  "selfdrive/ui/tests/test_bp_defaults_is_built.py",
  ...
  "sunnypilot/selfdrive/controls/lib/smart_cruise_control/tests/test_the_map_path_cannot_go_stale.py",
  ...
  "opendbc_repo/opendbc/sunnypilot/car/ford/tests/test_lane_center_damping.py",
  "selfdrive/ui/tests/test_lateral_settings_flat_point.py",
