...
SCENES = [
  ...
  ("a pass that is grinding",
   "SLOW PASS  14s", "barely gaining on the car you are passing", 0.0, True, AMBER),
  ...
  ("refused: nowhere to go on either side, with the reason in one word",
   "No lane to move into", "left: paint 0.30  -  no rear data  -  3 this drive", 0.0, False, GREY),
  ...
  ("blinker test: pressed again before the car stopped flashing",
   "WAITING FOR THE LAMP", "the car is still flashing from the last one", 0.0, True, AMBER),
