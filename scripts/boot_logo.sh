...
if [ "$DEVICE_TYPE" = "mici" ]; then
    readonly BLUEPILOT_BOOT_IMG="/data/openpilot/selfdrive/assets/img_fusionpilot_boot_mici.jpg"
else
    readonly BLUEPILOT_BOOT_IMG="/data/openpilot/selfdrive/assets/img_fusionpilot_boot.jpg"
fi

# Spinner logo (loading screen): source stored outside LFS; dest is what spinner.py loads
readonly BLUEPILOT_SPINNER_SRC="/data/openpilot/selfdrive/assets/images/spinner_fusionpilot.png"
