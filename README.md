...
- The radar detector integration, which needs a Valentine One Gen2 specifically, an FTDI USB-serial
  adapter specifically, and a soldering-free but non-trivial tap into the detector's accessory cord
